...
class ApiController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        $detail = $user::select('users.id as uid', 
                                ...
                                'jabatans.Nama_jabatan as jabatans', 
                                'jabatans.Besaran_uang as uangjabatan',
                                'golongans.Nama_golongan as golongans',
        ...
        $response["user"]["detail"]["jabatans"] = $detail["jabatans"];
        $response["user"]["detail"]["golongans"] = $detail["golongans"];
